/*
  ...
  Version SNAPSHOT_v9.0d_2012-11-25/LGPL Development Only (2012-11-25)
...
);isc.B._maxIndex=isc.C+53;isc.xml=isc.XML=isc.XMLTools;isc.defineClass("DataSource");isc.DS=isc.DataSource;isc.A=isc.DataSource;isc.A.dataSourceObjectSuffix="DS";isc.A._dataSources={};isc.A.$54v={};isc.A.$54w={};isc.A.$532="element";isc.A.$45t="type";isc.A.$99u={};isc.A.$99v={};isc.A.TABLE="table";isc.A.VIEW="view";isc.A.loaderURL="[ISOMORPHIC]/DataSourceLoader";isc.A.deepCloneOnEdit=true;isc.A.DS_FN={};isc.A.$37t="<soap:Envelope xmlns:soap='http://schemas.xmlsoap.org/soap/envelope/' ";isc.A.$37w="</soap:Envelope>";isc.A.$37u="<soap:Header>";isc.A.$51y="</soap:Header>";isc.A.$37v="<soap:Body";isc.A.$51z="</soap:Body>";isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$748="ref:";isc.A.serializeTimeAsDatetime=false;isc.A.$78d=[];isc.A.maxResponsesToCache=100;isc.A.offlineMessage="This data not available while offline";isc.A.$105n="$$DATE$$:";isc.A.$105o="$$TIME$$:";isc.B.push(isc.A.create=function isc_c_DataSource_create(_1,_2,_3,_4,_5,_6,_7,_8,_9,_10,_11,_12,_13){var _14=_1?_1.ID:null;if(isc.DataSource.$92w){var _15;if(_14)_15=isc.DataSource.get(_14);if(_15)return _15}
...
,isc.A.iscServer_strictJSONReviver=function isc_c_DataSource_iscServer_strictJSONReviver(_1,_2){if(isc.isA.String(_2)){if(_2.startsWith(isc.DataSource.$105n)){_2=_2.substring(9);if(_2.indexOf(":")==-1){var _3=_2.split("-");_2=Date.parseServerDate(parseInt(_3[0]),parseInt(_3[1])-1,parseInt(_3[2]))}else{var _3=_2.split(" ");var _4=_3[0].split("-"),_5=_3[1].split(":");var _6=new Date(28800000);_6.setUTCFullYear(_4[0]);_6.setUTCMonth(_4[1]-1);_6.setUTCDate(_4[2]);_6.setUTCHours(_5[0]);_6.setUTCMinutes(_5[1]);_6.setUTCSeconds(_5[2]);_2=_6}
...
return _3}
);isc.B._maxIndex=isc.C+11;isc.A=isc.DataSource.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$110l=200;isc.A.$41v="Action";isc.A.resultBatchSize=150;isc.A.$2j=[];isc.A.emptyExportMessage="You are attempting to export an empty dataset";isc.A.canExport=true;isc.A.defaultTitleFieldNames=["title","label","name","id"
...
if(this.cacheAllData&&this.hasAllData()){if(isc.isAn.Array(_3)){for(var i=0;i<_3.length;i++){var _7=this.findByKeys(_3[i],this.cacheData);if(_7>=0){this.cacheData[_7]=_3[i]}else{this.cacheData.add(_3[i])}
}
...
,isc.A.$110n=function isc_DataSource__asyncCopyLocalResults(_1,_2,_3,_4){var _5=_2;_2=Math.min(_2,_1+this.$110l);for(var i=_1;i<_2;++i){_3[i]=isc.addProperties({},_3[i])}
...
_8.append(">",_10,(_11?"":"\r"+_3));_8.append(isc.Comm.$36v(_4,_9,_2.nsPrefixes));return _8.toString()},isc.A.outputNSPrefixes=function isc_DataSource_outputNSPrefixes(_1,_2){delete _1.$36y;_1=isc.makeReverseMap(_1);var _3=isc.xml.$37l(_1,null,_2+"        ");return _3},isc.A.serializeAttributes=function isc_DataSource_serializeAttributes(_1,_2,_3){var _4=this.getFieldNames(),_5=true;for(var i=0;i<_4.length;i++){var _7=_4[i],_8=this.getField(_7);if(_8.xmlAttribute&&((_1&&_1[_7]!=null)||_8.xmlRequired)){if(_5){_1=isc.addProperties({},_1);_5=false}
...
var _8=this.filterPrimaryKeyFields(isc.clone(_2));_8.download_fieldname=_3;var _9=this.getField(_3);var _10=_9&&_9.nativeName?_9.nativeName:_3
_4.download_filename=_2[_10+"_filename"];_8.download_filename=_4.download_filename;return this.performDSOperation(_1,_8,null,_4)});isc.evalBoundary;isc.B.push(isc.A.$625=function isc_DataSource__getNextRequestId(){if(!this.$626)this.$626=[this.getID(),"$627"];this.$626[2]=isc.DataSource.$625();return this.$626.join(isc.emptyString)},isc.A.shouldUseStrictJSON=function isc_DataSource_shouldUseStrictJSON(_1){if(_1&&_1.useStrictJSON!=null)return _1.useStrictJSON;if(this.useStrictJSON!=null)return this.useStrictJSON;if(isc.Browser.isIE&&isc.Browser.version>=9&&isc.RPCManager.useJSONParse_IE9&&this.dataFormat=="iscServer")
{return true}
...
return this.recordsMatchingFilter([_1],_2,_3).length>0},isc.A.fieldMatchesFilter=function isc_DataSource_fieldMatchesFilter(_1,_2,_3){var _4;if(_3)_4=_3.textMatchStyle;if(isc.isAn.Array(_2)){if(!isc.isAn.Array(_1)){_1=[_1]}
if(_4==this.$50i){for(var i=0;i<_1.length;i++){if(!_2.contains(_1[i]))
return false}
return true}else{for(var i=0;i<_1.length;i++){if(_2.contains(_1[i]))
return true}
return false}}
if(isc.isAn.Array(_2)){if(_2.contains(_1))return true;return false}
...
if(!this.supportsTextMatchStyle(_4)){if(!this.$63c)this.$63c={};if(!this.$63c[_4]){this.logWarn("Text match style specified as '"+_4+"': This is not supported for this dataSource - performing a substring match instead");this.$63c[_4]=true}
...
return true});isc.B._maxIndex=isc.C+188;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$628=0;isc.A.$71l={sum:function(_1,_2,_3){var _4=0;for(var i=0;i<_2.length;i++){var _6=_1[_2[i].name],_7=parseFloat(_6);if(isc.isA.Number(_7)&&_7==_6){_4+=_7}else{if(_6!=null&&_6!=isc.emptyString){return null}}}
...
_14=isc.isA.Date(_10)||isc.isA.Date(_11);_15=isc.isA.Number(_10)||isc.isA.Number(_11);_16=isc.isA.String(_10)||isc.isA.String(_11);_6=_70.getField(_47);_7=isc.DataSource.getPathValue(_67,_47,_6);var _18=_16&&_69.caseInsensitive;if(_7===null||_7===_17){if(_14)_7=_69.upperBounds?new Date(95649074640000):new Date(-8640000000000000);else if(_15)_7=_69.upperBounds?Number.MAX_VALUE:Number.MIN_VALUE;else _7=""}else{if(_15&&isNaN(_7)){_10=""+_10;_11=""+_11}
...
,isc.A.canQueueRequest=function isc_c_RPCManager_canQueueRequest(_1,_2){if(_1.ignoreTimeout)_1.sendNoQueue=true;var _3=_1.transport;if(_1.directSubmit||_1.downloadResult||_1.target){if(_1.transport!="hiddenFrame"){if(_2){this.logWarn("request specified explicit transport: "+_3
...
_4.sendTime=isc.timeStamp();_4.changed();_4.callback="isc.RPCManager.performTransactionReply(transactionNum,results,wd)";if(_1)_4.$40c=_1;if(_5.directSubmit){isc.Comm.generateJSCallback(_4);var _16=_5.submitForm;var _17=_16.getForm();if(_16.getItem("_transaction")!=null&&isc.isA.HiddenItem(_16.getItem("_transaction")))
...
}else if(_5.downloadResult){if(!window.name)window.name=isc.timeStamp();var _19=_4.download_filename||"request_"+isc.timeStamp();if(_5.downloadToNewWindow==false||(_5.downloadToNewWindow==null&&_5.exportFilename)){var _19=window.name}
...
this.$39a(_4);var _22;if(_5.isRestRequest){if(_4.operations.length>1){if(_5.contentType==this.$89f){_22="<transaction transactionNum=\""+_4.transactionNum+"\">";_22+="<operations>"
for(var i=0;i<_4.operations.length;i++){if(_4.operations[i].clientOnly)continue;_22+=_4.operations[i].data}
_22+="</operations>";_22+="</transaction>"}else{_22="{ \"transaction\": { \"transactionNum\": "+_4.transactionNum+", ";_22+="\"operations\": [";for(var i=0;i<_4.operations.length;i++){if(_4.operations[i].clientOnly)continue;if(i>0)_22+=", ";_22+=_4.operations[i].data}
_22+="]}}"}
}else{_22=_5.data}
...
);isc.evalBoundary;isc.B.push(isc.A.responseIsRelogin=function isc_c_RPCManager_responseIsRelogin(_1,_2){var _3=_1.status;if(document.domain!=location.hostname&&((_3==302&&this.treatRedirectAsRelogin)||(_3==0)||(_3==200&&_1.getAllResponseHeaders()==isc.emptyString&&_1.responseText==isc.emptyString)
))
...
_2.results=isc.Class.parseStrictJSON(_8,_6,true,true)}
}else{_2.results=isc.Class.parseStrictJSON(_8,_6)}
}else{_2.results=isc.eval("("+_8+")",!_4)}
}catch(e){this.logWarn("Error evaling structured RPC response: "+e.message
+" response text: "+_8);_3=false}
}else{var _9=_2.operations[0];if(_9&&_9.isRestRequest){var _10=isc.DataSource.get(_9.dataSource);if(_10){if(_9&&_9.dataFormat=="json"&&_10.jsonPrefix==null)
{_3=true}else{var _11=_2.results?_2.results.indexOf(_10.jsonPrefix):-1;_3=_11!=-1}
if(_3){var _12=_2.results;_12=this.$89n(_12,_10);try{if(_5){_2.results=isc.Class.parseStrictJSON(_8,_6)}else{_2.results=isc.eval("("+_12+")",(_4?false:true))}
...
if(!_3){var _13=isc.isAn.Array(_2.operations)?_2.operations[0]
:null;if(_13&&_13.isRestRequest&&_2.operations.length>1){if(_13.dataFormat=="json"){this.logWarn("Found a REST request that appears to be in JSON format, but the response was not wrapped as configured by the jsonPrefix and jsonSuffix properties - aborting")
return}else{_2.results=this.$89g(_2.results);_3=_2.results!=null}
}
}
}
var _14=_2.results;if(_3&&!isc.isAn.Array(_14))_14=[_14];var _15=_2.operations,_16=[];_2.$66n=true;for(var i=0,j=0;i<_15.length;i++){var _9=_15[i];var _19;if(_3&&_9.clientOnly){_19=isc.addProperties(this.createRPCResponse(_2,_9),{isStructured:false
})}else{_19=isc.addProperties(this.createRPCResponse(_2,_9),{isStructured:_3,callbackArgs:_2.transport=="scriptInclude"?_14:null,results:_3?_14[j]:_14
});if(_3&&_9.isRestRequest){isc.addProperties(_19,{data:_14[j]})}
j++}
...
{var _9=_15[_21],_19=_16[_21];this.performOperationReply(_9,_19);_21++}
...
delete _2.abortCallbacks;delete _2.$66n;if(_2.offline)this.playbackNextOfflineTransaction();if(_2.$40c){var _22=_9.application?_9.application
...
);isc.B._maxIndex=isc.C+81;isc.RPCManager.rpc_logMessage=isc.RPCManager.logMessage;isc.RPCManager.logMessage=function(_1,_2,_3,_4){if(this.logIsEnabledFor(_1,_3)){if(isc.isA.String(_2)&&_2.length>this.maxLogMessageLength
...
,isc.A.$37y=function isc_c_DataSource__getDataSourceReply(_1,_2,_3){var _4=_2==null||_2.length==0,_5=!_4?_2[0].dsName:_3.dsName;if(_1.status!=0||_4){isc.DataSource.logError("dynamic datasource fetch failed for datasource '"+_5+"'. "
+(isc.isA.String(_2)?_2:""));return}
...
};if(_7)_8.textMatchStyle=_7;isc.addProperties(_6,_1.appInputs,_1.parameters);if(_1.startRow!=null){_6.startRow=_1.startRow}
...
var _9=_3.application||isc.RPCManager.getDefaultApplication();if(isc.isAn.Object(_9))_9=_9.ID;var _10=_3.operation||_3.operationId||this.ID+"_"+_5;if(isc.isAn.Object(_10))_10=_10.ID;isc.addProperties(_6,{appID:_9,operation:_10,oldValues:_1.oldValues
});if(_1.outputs){isc.addProperties(_6,{outputs:_1.outputs
})}
...
_3._dsRequest=_1;this.logInfo("performDSOperation("+_5+") "
+(isc.isAn.Array(_2)?_2.length:1)+" records"
+(isc.rpc.queuing?", queuing":""));_3.callback={target:this,methodName:"$50h"};if(isc.DataSource.addMetaDataToQueryString){if(!_3.queryParams)_3.queryParams={};isc.addProperties(_3.queryParams,{ds_name:_1.dataSource,ds_op:_1.operationType
});if(_1.startRow!=null){isc.addProperties(_3.queryParams,{ds_startRow:_1.startRow,ds_endRow:_1.endRow
})}
...
_4.application=this;if(_4.showPrompt!==false)_4.showPrompt=true;var _5=this.getOperationConfig(_1);if(!_5){_1={ID:_1,source:"auto"}}else _1=_5;if(_1!=null)_4.operation=_1;if(_3!=null&&_4.callback==null)_4.callback=_3;this.logInfo("performOperation("+_1.ID+")["+_1.type+"]:'"+(isc.isAn.Array(_2)?_2.length:1)+" records"
+(this.queuing?", queuing":""));var _6={appID:this.ID,operation:_1.ID,values:_2
};isc.addProperties(_6,_4.appInputs);_4.operation=_1;_4.data=_6;return isc.RPCManager.sendRequest(_4)}
...
if(!_4)_4=_5.getName();var _12="",_13="AUTO_FORM_"+isc.Comm.$hz++;_12+="Submitting to:<B>"+_2+"</B><BR>";_12+="<FORM ID="+_13
+" METHOD="+(_8?_8:isc.Comm.sendMethod)
+" ENCTYPE='application/x-www-form-urlencoded' ACTION='"+_2.replace("'","&apos;")+"'"
+(_4!=window?" TARGET='"+_4+"'":"")
+">";for(var _14 in _3){var _15=_3[_14];if(isc.isA.Function(_15))continue;_12+="<B>"+_14+" :</B><BR>\r&nbsp;&nbsp;"
...
,isc.A.generateJSCallback=function isc_c_Comm_generateJSCallback(_1){var _2=_1.transactionNum,_3=_1.callback,_4=isc.Comm.alwaysSendInNewWindow
?"window.opener.parent.isc.Comm.hiddenFrameReply("+_2+",results,window)"
:("if (!(new RegExp(\"^(\\\\d{1,3}\\\\.){3}\\\\d{1,3}$\").test(document.domain))) {while (!window.isc && document.domain.indexOf(\".\") != -1 ) { try { parent.isc; break} catch (e) {document.domain = document.domain.replace(/.*?\\./, \"\")}}}parent.isc.Comm.hiddenFrameReply("+_2+",results)"
);_1.requestData.jscallback=_4;this.$50c[_2]=_3}
...
,isc.A.closeOperationPromptWindow=function isc_c_Comm_closeOperationPromptWindow(_1){if(!_1||_1.transport!="hiddenFrame")return;var _2=_1.$ch;if(_2==null){return}
_1.$ch=null;if(isc.isA.HiddenFrame(_2)){_2.destroy();isc.HiddenFrame.$h7()}else{if(isc.isA.Function(_2.close))_2.close()}}
...
if(this.builder&&this.builder.markDirty)this.builder.markDirty();isc.addProperties(_1.initData,_2);_1.$71u=true;var _3=_1.liveObject;var _4=isc.DS.get(_1.type);if(_2.name!=null&&(isc.isA.FormItem(_3)||(_4&&(_4.inheritsSchema("ListGridField")||_4.inheritsSchema("DetailViewerField")))))
...
var _9=isc.addProperties({showPrompt:false,actionURL:this.contentsURL,httpMethod:_7,useSimpleHttp:_6,bypassCache:!this.allowCaching,params:_5
