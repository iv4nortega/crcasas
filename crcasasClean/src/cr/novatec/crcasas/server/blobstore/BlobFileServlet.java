...
public class BlobFileServlet extends HttpServlet {
		...
		public void doPost(HttpServletRequest req, HttpServletResponse res)
			...
			try {
		        ...
		        if (blobKey == null) {
		        	...
		        	res.sendRedirect("/restlet/file/" + blobKey.getKeyString() + "/metapro");	        	
	        	...
	        	db.sentEmail("OTHER BlobstoreServlet exception", e.getMessage());
