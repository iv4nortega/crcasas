...
public class QueueClean extends HttpServlet {
	...
	throws IOException {
		...
		try {
			...
			//queue.add(TaskOptions.Builder.withUrl("/tasks/archive").retryOptions(retry));
			
			strCallResult = "Successfully clean tasks";
			
			

			Queue queue = QueueFactory.getDefaultQueue();
			
			TaskOptions taskOptions = TaskOptions.Builder.withUrl("/tasks/clean")
					                  .retryOptions(retry)
