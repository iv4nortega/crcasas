...
public class PremiumAdsResource extends ServerResource implements AdResource {
	...
	public JSONObject toJson(Ad ad) throws JSONException {
		...
		if ( ad.getImageUrl()!=null ) j.put("imgUrl", ad.getImageUrl()+"=s500-c");
